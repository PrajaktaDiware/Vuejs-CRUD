<template>
    <div id="all-products">
        ...
        <p><router-link :to="{ name: 'create_product' }" class="btn btn-outline-info">Create Product</router-link></p>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr v-for="product in products">
                    ...
                    <td>{{ product.price }}</td>
                    <td>
                        <router-link :to="{name: 'edit_product', params: { id: product.id }}" class="btn btn-outline-primary">Edit</router-link>
                        <router-link :to="{name: 'delete_product', params: { id: product.id }}" class="btn btn-outline-danger">Delete</router-link>
                    </td>
                </tr>
            </tbody>
        </table>
